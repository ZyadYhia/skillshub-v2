                ...
                <div class="row">
                    <div class="col-12 pb-3">
                        ...
                        <form id="add-new-form" enctype="multipart/form-data"
                            action="{{ url("dashboard/exams/update/$exam->id") }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>Name (AR)</label>
                                            <input type="text" class="form-control" name="name_ar" style="direction: rtl;" value="{{$exam->name('ar')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label> Description (EN)</label>
                                    <textarea name="desc_en" class="form-control" rows="5">{{$exam->desc('en')}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label> Description (AR)</label>
                                    <textarea name="desc_ar" class="form-control" style="direction: rtl;" rows="5">{{$exam->desc('ar')}}</textarea>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
